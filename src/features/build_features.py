...
if __name__ == "__main__":
    ...
    sample = pd.DataFrame({
        ...
        "TopographyDrainage": [8.0, 4.0],
        "RiverManagement": [7.0, 3.0],
        "Deforestation": [6.0, 2.0],
        "Urbanization": [8.0, 4.0],
        "ClimateChange": [9.0, 5.0],
        "DamsQuality": [5.0, 2.0],
        "Siltation": [4.0, 2.0],
        "AgriculturalPractices": [3.0, 1.0],
        "Encroachments": [2.0, 1.0],
        "WetlandLoss": [1.0, 0.5],
        "ClimateChange": [9.0, 5.0],
    ...
    adder.fit(sample)
    transformed = adder.transform(sample)
    print("Output features:", list(transformed.columns))
    print("Sample output:\n", transformed.iloc[0].to_dict())